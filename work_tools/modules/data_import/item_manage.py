...
from work_tools.models import ItemDetail, ImportJob
from work_tools.forms import ItemImportForm
from work_tools.navigation import get_sidebar_groups
from work_tools.views.base import normalize_item_id
...
def item_import_view(request):
    ...
    if request.method == 'POST':
        ...
        return render(request, 'modules/data_import/item_import.html', {
            'form': form,
