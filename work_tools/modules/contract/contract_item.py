...
from work_tools.forms import ContractItemUpdateForm
from work_tools.navigation import get_sidebar_groups
from work_tools.models import ItemDetail
from work_tools.config import get_config
from work_tools.sql_merge import chunk_list, format_in, merge_by_key
from work_tools.views.base import parse_ops_remark, normalize_item_id, save_sql_file
        ...
        if form.is_valid():
            ...
            if cd.get('excel_file'):
                ...
                if not validation_result['valid']:
                    ...
                    # 不生成SQL，直接返回页面显示错误
                    return render(request, 'modules/contract/contract_item_form.html', {
                        'form': form,
