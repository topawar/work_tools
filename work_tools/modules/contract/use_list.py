...
from work_tools.forms import UseListUpdateForm
...
from work_tools.views.base import parse_ops_remark, extract_company_code, extract_company_name, save_sql_file
            ...
            try:
                ...
                if cd.get('excel_file'):
                    ...
                    if not validation_result['valid']:
                        ...
                        return render(request, 'modules/contract/use_list_update_form.html', {
                            'form': form,
