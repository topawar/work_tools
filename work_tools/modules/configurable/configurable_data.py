...
from work_tools.models import ConfigurableTable, ConfigurableField
from work_tools.navigation import get_sidebar_groups
from work_tools.config import get_config
from work_tools.sql_merge import chunk_list, format_in, merge_by_key, to_literal
...
def configurable_data_view(request, table_code):
    ...
    return render(request, 'modules/configurable/configurable_data.html', {
        'form': form,
