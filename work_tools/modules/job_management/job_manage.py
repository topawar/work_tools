...
from work_tools.models import ImportJob
...
def job_list_view(request):
    ...
    return render(request, 'modules/job_management/jobs.html', {
        'jobs': jobs,
...
def job_detail_view(request, job_id):
    ...
    return render(request, 'modules/job_management/job_detail.html', {
        'job': job,
        'active_menu': 'job_list',
        'sidebar_groups': get_sidebar_groups(),
    })
