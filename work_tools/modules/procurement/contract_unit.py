...
from work_tools.forms import UnitChangeForm
...
from work_tools.sql_merge import chunk_list, format_in, merge_by_key, compose_or
from work_tools.logger_utils import log_view_input
from work_tools.views.base import parse_ops_remark, extract_company_code, extract_company_name, _unique_code_by_name, save_sql_file
        ...
        if form.is_valid():
            ...
            if cd.get('excel_file'):
                ...
                if not validation_result['valid']:
                    ...
                    return render(request, 'modules/procurement/unit_change_form.html', {
                        'form': form,
