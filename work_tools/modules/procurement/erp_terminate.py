...
from work_tools.forms import ErpTerminateForm
from work_tools.navigation import get_sidebar_groups
from work_tools.config import get_config
from work_tools.sql_merge import chunk_list, format_in
        ...
        if form.is_valid():
            ...
            if cd.get('excel_file'):
                ...
                if not validation_result['valid']:
                    ...
                    return render(request, 'modules/procurement/erp_terminate_form.html', {
                        'form': form,
