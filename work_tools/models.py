...
class UserOrgDetail(models.Model):
    ...
    login_name = models.CharField(
        max_length=255, null=True, blank=True, verbose_name="登录名"
    )
    user_name = models.CharField(
        max_length=255, null=True, blank=True, verbose_name="用户名"
    )
    dept_code = models.CharField(
        max_length=255, null=True, blank=True, verbose_name="部门编码"
    )
    dept_name = models.CharField(
        max_length=255, null=True, blank=True, verbose_name="部门名称"
    )
    company_code = models.CharField(
        max_length=255, null=True, blank=True, verbose_name="公司编码"
    )
    company_name = models.CharField(
        max_length=255, null=True, blank=True, verbose_name="公司名称"
    )
    plate_code = models.CharField(
        max_length=255, null=True, blank=True, verbose_name="板块编码"
    )
    plate_name = models.CharField(
        max_length=255, null=True, blank=True, verbose_name="板块名称"
    )
...
class ConfigurableField(models.Model):
    ...
    field_type = models.CharField(
        max_length=20, choices=FIELD_TYPE_CHOICES, verbose_name="字段类型"
    )
    field_name = models.CharField(max_length=100, verbose_name="数据库字段名")
    display_name = models.CharField(max_length=200, verbose_name="显示名称")
    data_type = models.CharField(
        max_length=20, choices=DATA_TYPE_CHOICES, verbose_name="数据类型"
    )
